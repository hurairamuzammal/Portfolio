...
const LINKEDIN_PROJECTS = [
    {
        ...
        description: "Developed multiple Flutter applications.",
        role: "KaiRiz Cybersecurity",
        date: "2024"
    }
];
...
const CERTIFICATES_DATA = [
    {
        ...
        issuer: "Google / Certification Authority",
        date: "2024",
        icon: SiFlutter,
        color: "text-[#02569B]",
        bg: "bg-[#02569B]/10",
            ...
            <nav className="fixed top-6 w-full z-50 transition-all duration-500 ease-in-out px-6">
                <div className="mx-auto rounded-full border border-[#38bdf8]/30 bg-[#020617]/60 backdrop-blur-xl shadow-[0_0_20px_rgba(56,189,248,0.15)] flex items-center justify-between max-w-5xl px-8 py-4 transition-all duration-500 hover:shadow-[0_0_30px_rgba(56,189,248,0.3)] hover:border-[#38bdf8]/50">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Link to="/projects" className="text-sm font-semibold text-slate-300 hover:text-[#38bdf8] transition-colors">Projects</Link>
                ...
                >
                    <div className="flex-1 flex flex-col items-start gap-8">
                        ...
                        <div className="flex items-center gap-6 mt-2">
                            <Link to="/projects" className="px-8 py-4 rounded-full bg-[#0ea5e9] text-white font-bold text-lg hover:bg-[#0284c7] transition-all hover:scale-105 active:scale-95 flex items-center gap-2 shadow-[0_10px_20px_rgba(14,165,233,0.3)]">
            ...
            <main className="relative z-10 py-24 px-6 lg:px-12 max-w-6xl mx-auto w-full flex flex-col gap-32">
                ...
                <section id="tech-stack" className="scroll-mt-32 w-full p-8 md:p-12 lg:p-16 rounded-[3rem] bg-[#020617]/40 backdrop-blur-xl border border-white/5 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                    <div className="flex flex-col items-center text-center gap-4 mb-16">
                        <h2 className="text-4xl font-black text-white tracking-tight">Tools & Technologies</h2>
                        <p className="text-lg md:text-xl text-slate-400 font-light max-w-2xl px-4">
                            I have actively worked with and utilized these tools and technologies to build scalable, high-performance applications.
                        </p>
                    </div>
                ...
                <section id="projects" className="scroll-mt-32 w-full p-8 md:p-12 lg:p-16 rounded-[3rem] bg-[#020617]/40 backdrop-blur-xl border border-white/5 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                    <div className="flex items-center justify-between mb-16">
                        <h2 className="text-4xl font-black text-white tracking-tight">Featured Projects</h2>
                        <Link to="/projects" className="hidden sm:flex px-6 py-2.5 rounded-full border border-[#38bdf8]/30 text-[#38bdf8] hover:bg-[#38bdf8]/10 hover:border-[#38bdf8]/50 transition-all font-semibold gap-2 items-center tracking-wide">
                    ...
                    <div className="mt-10 sm:hidden flex justify-center">
                        <Link to="/projects" className="px-6 py-3 rounded-full border border-[#38bdf8]/30 text-[#38bdf8] hover:bg-[#38bdf8]/10 transition-all font-semibold flex gap-2 items-center tracking-wide">
                ...
                <section className="flex flex-col gap-32">
                    ...
                    <div id="certificates" className="scroll-mt-32 w-full p-8 md:p-12 lg:p-16 rounded-[3rem] bg-[#020617]/40 backdrop-blur-xl border border-white/5 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {CERTIFICATES_DATA.map((cert, idx) => (
                                <motion.div
                                    ...
                                    transition={{ delay: idx * 0.1 }}
                                    key={idx}
                                    className={`flex items-start gap-6 p-8 rounded-3xl bg-[#0f172a]/60 backdrop-blur-xl border ${cert.border} shadow-lg hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] transition-all group`}
                                >
                                    <div className={`w-16 h-16 rounded-[1.2rem] ${cert.bg} flex items-center justify-center ${cert.color} flex-shrink-0 group-hover:scale-110 transition-transform`}>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex flex-col mt-1">
                                            ...
                                            <span className="text-sm font-bold text-slate-500 tracking-wider uppercase mt-2">{cert.date}</span>
                                        </div>
                                    </div>
                                </motion.div>
                            ))}
